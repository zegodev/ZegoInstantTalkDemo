...
public class CirImageView extends ImageView {
    ...
    public CirImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CirImageView, defStyle, 0);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CirImageView_borderWidthEx, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CirImageView_borderColor, DEFAULT_BORDER_COLOR);
        a.recycle();
